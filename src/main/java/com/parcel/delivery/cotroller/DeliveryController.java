...
@RestController
@RequestMapping(value= "/delivery/v1/", produces = {"application/json"})
public class DeliveryController {
    ...
    @PutMapping(value= "/parcel", consumes = {"application/json"})
    ...
    @PostMapping(value= "/parcel", consumes = {"application/json"})
